...
var ColorPicker = function () {
    ...
    return {
        ...
        getDefaultColorHex: function() {
            return defaultColorHex;
        },
        getTransparencyControl: function() {
            return transparencyControl;
        },
        getDefaultTransparencyValue: function() {
            return defaultTransparencyValue;
        },
        getPicker: function() {
            return picker;
        },
        setVariables: function () {
            quickColorsBox = document.getElementById("colorPicker").querySelectorAll(".quickColorsBox");
            colorToInitWith =
                kml.utils.colorObjToArr(arrDefaultColorRGBA || defaultColor);
                    ...
                    slider = function () {
                        var transparencySliderValue = content.getElementsByClassName("transparencySliderValue")[0],
                            ...
                            getValue = function (newVal) {
                                return Math.round(100 - (newVal <= 1 ? newVal : newVal / 255) * 100);
                            },
                        ...
                        return {
                            get: function () {
                                return sliderUI ? Math.round((100 - sliderUI.getValue()) / 100 * 255) : 0;
                            },
                            set: function (val) {
        ...
        formColorPicker: function () {
            ...
            var getColorElement = function() {
                    return document.getElementById("colorPicker").querySelector("INPUT:not([type='radio'])");
                },
                customColorToInternal = function (customColor) {
                    ...
                    if (Math.max.apply(Math, color) > 1) {
                        color = color.map(function (value) {
                            return (typeof value === "undefined") ? 1 : value / 255;
                        });
                    }
                    ...
                    var isSupportColor = kml.utils.inputTypeSupport("color", "hello world"),
                        nativeColorPicker = function () {
                            ...
                            return {
                                ...
                                getValue: function () {
                                    return kml.utils.hexToRGBArray(elem.value);
                                },
                        ...
                        jqueryColorPicker = function () {
                            ...
                            return {
                                ...
                                getValue: function () {
                                    return (picker.rgb || defaultColor).map(function (val) {
                                        return val * 255;
                                    });
                                },
                                getHexValue: function () {
        ...
        setQuickColor: function (e) {
            ...
            document.getElementById("colorPickerField").value = picker.getHexValue();
